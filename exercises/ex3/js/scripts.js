...
var colors = ["#E63946", "#E96A70", "#EC9A9A", "#EFCAC4", "#F1FAEE", "#A8DADC", "#77ABBD", "#457B9D", "#31587A", "#1D3557"];
...
toggleColor = function () {
    ...
    this.style.background = rectangles[index]["isToggled"]? rectangles[index]["color"] : "white";
